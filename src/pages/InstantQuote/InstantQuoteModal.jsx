  ...
  return (
    <>
      <Modal
        open={open}
        onClose={handleClose}
        className="rounded-[12px] block max-md:hidden"
        sx={{
      ...
      >
        ...
        >
          <div className="bg-[#1A1A1A] m-4 rounded-[12px] px-6 py-4 text-white space-y-4">
            <div className="flex flex-row justify-between items-start max-md:gap-20">
              <div className="flex flex-row items-center gap-10 max-md:flex-col">
