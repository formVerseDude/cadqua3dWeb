...
export default function CompanyStatistics() {
  ...
  return (
    <div className="bg-[#000000] pt-20 pb-10 flex flex-row max-md:flex-col gap-16 max-md:gap-8 justify-center items-center px-40 max-lg:px-20 max-md:px-10 pb-10">
