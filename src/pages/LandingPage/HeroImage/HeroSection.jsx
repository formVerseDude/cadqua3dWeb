    ...
    <div className="relative h-full">
      ...
      <div className="absolute top-10 w-full z-20">
        <motion.h2
          ...
          variants={variants}
          viewport={{ once: true }}
          className="flex justify-center text-[#938068] text-[20px] font-blacksword sm:text-4xl md:text-6xl"
        >
          {letters.map((word, i) => (
            <motion.span
              className="mr-[20px]"
      ...
      <div className="absolute bottom-14 w-full flex justify-center z-20">
